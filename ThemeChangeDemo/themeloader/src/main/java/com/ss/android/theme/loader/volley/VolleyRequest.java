...
import com.ss.android.theme.loader.parser.BaseParser;
import com.ss.android.theme.loader.volley.toolbox.HttpHeaderParser;
import com.ss.android.theme.loader.volley.toolbox.ResponseListener;
import com.ss.android.theme.loader.volley.toolbox.Volley;
...
public class VolleyRequest<T extends BaseBean> extends Request<T> {
	...
	protected Response<T> parseNetworkResponse(NetworkResponse response) {
		try {
            ...
            return Response.error(new VolleyError(ResponseListener.NetworkResponseState.RESULT_ERROR));
